...
import { ORDERCOLUMNS } from '../columns/ordersColumn'
...
const OrderTable = ({data}) => {
  ...
  return (
    <>
    <table {...getTableProps()} className="border border-slate-300 rounded-md w-full text-center text-sm bg-white "  >
        <thead className='font-thin text-slate-500 text-center'>
            {
